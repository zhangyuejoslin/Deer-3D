...
def scanrefer_get_unique_multiple_lookup():
    unique_multiple_lookup_file = '/nas-ssd2/yuezhang/yue_data/chat_scene_data/annotations/scanrefer_unique_multiple_lookup.json'
    if not os.path.exists(unique_multiple_lookup_file):
        ...
        raw2label = {}
        with open('/nas-ssd2/yuezhang/yue_data/chat_scene_data/annotations/scannet/scannetv2-labels.combined.tsv', 'r') as f:
        ...
        scanrefer_data = json.load(open('/nas-ssd2/yuezhang/yue_data/chat_scene_data/annotations/scanrefer/ScanRefer_filtered.json'))
